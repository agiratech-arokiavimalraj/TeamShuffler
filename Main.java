...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do{
            if(mainMenu) {
                System.out.println("1.Get Start 2.Reshuffle 3.Recreate 4.exit");
                    ...
                    case 1:{
                        do {
                            ...
                            if (playerCount <= 22 && playerCount > 1 && tri<=2) {
                                ...
                                team =new TeamShuffler(finder,playerName,playerCount);
                                process(team.finder, team.playerName,team.playerCount);
                                System.out.println("");
                                mainMenu=true;
                                break;
                            } else if (tri==2) {
